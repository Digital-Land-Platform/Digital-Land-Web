    ...
    return (
        <nav className="bg-gray-800 p-4" data-testid="navbar-component">
            <ul className="flex justify-around list-none m-0 p-0">
                <li className="m-0">
                    <a href="/" className="text-white text-lg no-underline hover:underline">Home</a>
                </li>
                <li className="m-0">
                    <a href="/about" className="text-white text-lg no-underline hover:underline">About</a>
                </li>
                <li className="m-0">
                    <a href="/contact" className="text-white text-lg no-underline hover:underline">Contact</a>
                </li>
            </ul>
        </nav>
    );
